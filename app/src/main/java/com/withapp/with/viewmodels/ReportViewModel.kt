...
//
//    // Precise Values from your screenshots
...
//
//    init {
//        // High-precision init (Screenshot 13:14, 13:23)
...
//    }
//
//    // 🚀 THE MAGIC SYNC ENGINE (Supports Chinese)
...
//        when {
//            input.contains("吃") || input.contains("餐") || input.contains("饭") -> dietLogs.add(0, DietEntry(time, input, "待估算"))
//            input.contains("跑") || input.contains("步") || input.contains("动") -> exerciseLogs.add(0, ExerciseEntry(time, input, "30min"))
//            input.contains("心") || input.contains("跳") -> hrLogs.add(0, HeartRateEntry(time, 82, "自动识别"))
